import { kumarOneOutline, pirataOne, zenDots } from "@/lib/googleFonts";
  ...
  const achievements: Achievement[] = [
    {
      ...
      link: "https://leetcode.com/u/its_Shinde4241/",
    },
    {
      label: "Codechef",
      logo: (
      ...
      link: "https://www.codechef.com/users/itzshinde4241",
    },
    {
      label: "Codeforces",
      logo: (
      ...
      link: "https://codeforces.com/profile/its_Shinde4241",
    },
  ];

  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-10 p-4">
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-center gap-10 md:gap-8">
        {/* Left: Text Content */}
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
          <h1
            className={`${kumarOneOutline.className} text-lg sm:text-xl md:text-2xl lg:text-4xl opacity-80`}
          >
          ...
          <div className="flex flex-col">
            <TextDecrypt
              text="Web"
              className={`${zenDots.className} text-4xl sm:text-5xl md:text-5xl lg:text-7xl pt-2 sm:pt-3`}
            />
            <TextDecrypt
              text="Developer"
          ...
          {/* Achievements below text for md and up */}
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center justify-center gap-6 relative">
          ...
          <div className="flex md:hidden gap-3 justify-center">
            {achievements.map((item, index) => (
              <Card
                key={index}
                className="px-2 py-1 hover:scale-105 transition-transform"
              >
                <Link
                  href={item.link}
                  target="_blank"
